...
| 色名 | 色值 |  用途 |
|------|------|------|
| 绿 | `#CEE7E1` |   主色调、标题、超链接、重点标记 |
| 红 | `#F0686C` | 强调、装饰、badges、连接线、高亮 |
| 黄 | `#FFEEBC` | 点缀、高亮下划线、CTA、标签 |

三色比例原则: 绿55% · 红30% · 黄15%（黄永远是点缀，不做主色）

---

## 🐱 IP形象规范

Tami 的固定视觉形象（character.png），以下元素不可更改：

- **珊瑚红猫咪线稿** —— 品牌识别第一要素
- **侧身坐姿轮廓** —— 优雅、安静、治愈
- **卷曲大尾巴** —— 灵动可爱，增强记忆点
- **手写体“Tami”字样** —— 温柔亲切，具有陪伴感
- **黄色小爪印** —— 活泼点缀，突出猫咪属性
- **浅青绿色纸纹背景** —— 清新柔和，营造温暖氛围


### 素材文件
- **头像** — `assets/avatar.jpg`（线条猫咪，适用于个人介绍区、头像集群等）
